...
export enum AuditEventType {
  ...
  CERTIFICATE_ISSUED_IN_MEMORY = 'CERTIFICATE_ISSUED_IN_MEMORY',
  ...
  OTA_SIGNING_CONFIRMED = 'OTA_SIGNING_CONFIRMED',
  OTA_SIGNING_KEY_LOADED = 'OTA_SIGNING_KEY_LOADED',
  OTA_SIGNING_KEY_ROTATED = 'OTA_SIGNING_KEY_ROTATED',
  OTA_SIGNING_KEY_COMPROMISE = 'OTA_SIGNING_KEY_COMPROMISE',
  OTA_RELEASE_LOG_ENTRY = 'OTA_RELEASE_LOG_ENTRY',
  OTA_ROLLOUT_HALTED = 'OTA_ROLLOUT_HALTED',
  OTA_ROLLOUT_RETRYABLE = 'OTA_ROLLOUT_RETRYABLE',
  OTA_ROLLOUT_RETRIED = 'OTA_ROLLOUT_RETRIED',
}
