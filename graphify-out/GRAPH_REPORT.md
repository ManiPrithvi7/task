...
## Corpus Check
- 276 files · ~143,957 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2381 nodes · 4824 edges · 194 communities (132 shown, 62 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 26 edges (avg confidence: 0.58)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `399478cf`
...
Cohesion: 0.06
Nodes (43): abandonAttentionCorrelation(), applyInstagramServerlessDeviceOutcome(), areInstagramPollingScriptsLoaded(), atomicBackoffCheckAndRecordLua, atomicFetchBudgetTryLua, atomicPriorityReadAndPruneLua, AttentionE2eLatencySnapshot, buildLatencySnapshot() (+35 more)

### Community 3 - "Community 3"
Cohesion: 0.08
Nodes (19): GmbReviewSnapshotInfluxInput, GmbVelocityWeeklyInfluxInput, GmbWebhookAuditInfluxInput, InstagramCircuitEventInfluxInput, InstagramFetchAuditInfluxInput, InstagramMilestoneCrossedInfluxInput, InstagramMqttDeliveryInfluxInput, MilestoneCrossedInfluxInput (+11 more)

### Community 4 - "Community 4"
Cohesion: 0.11
Nodes (26): ensureFreshInstagramAccessToken(), InstagramTokenContext, loadInstagramTokenContextForUser(), getGmbAccountLookupValues(), resolveGmbContextForDevice(), GoogleBusinessLocation, GoogleBusinessLocationSchema, IGoogleBusinessLocation (+18 more)
...
Cohesion: 0.12
Nodes (29): getClaimBaseUrl(), resolveConnectionsValidateApiKey(), Campaign, ConnectionsRoutesDeps, createConnectionsRoutes(), PROVIDER_MAP, VALID_EVENTS, invalidateCanvasCache() (+21 more)
...
Cohesion: 0.12
Nodes (24): checkSchedulerHeartbeat(), processRollouts(), RolloutSchedulerHandle, dashboardLink(), formatText(), sendOtaSlackAlert(), SlackOtaAlertKind, SlackOtaAlertPayload (+16 more)

### Community 9 - "Community 9"
Cohesion: 0.10
Nodes (25): ObjectHeadResult, assertValidSha256Hex(), assertValidVersionFormat(), eventKey(), FinalizeValidationCode, FinalizeValidationError, FinalizeValidationInput, OtaActiveRelease (+17 more)

### Community 10 - "Community 10"
Cohesion: 0.19
Nodes (5): Device, FirmwareRelease, IFirmwareRelease, OtaService, isVersionGreater()
...
Cohesion: 0.08
Nodes (16): StatsMqttLite, createInfluxService(), resetInfluxService(), BufferedMqttMessage, flushMessageBuffer(), handleCritical(), handleNonCritical(), isLifecycleTopic() (+8 more)
...
Cohesion: 0.05
Nodes (43): compression, cors, dotenv, express, express-rate-limit, google-auth-library, googleapis, helmet (+35 more)
...
Cohesion: 0.21
Nodes (8): app, SessionData, BaseInfluxRepo, OtaReleaseEntryInput, TransparencyEntryInput, PkiAuditInput, BucketTarget, logger
...
Cohesion: 0.12
Nodes (12): OtaConfig, OtaAdminRoutesDeps, FirmwareStorageService, IFirmwareStorage, OtaCommandPublisher, buildOtaDownloadUrl(), buildOtaMqttDownloadUrl(), isLocalLanDownloadUrl() (+4 more)

### Community 21 - "Community 21"
Cohesion: 0.16
Nodes (15): nsToMs(), WebhookLatencyStages, WebhookLatencyTracker, WebhookProvider, tryClaimWebhookDedupe(), ack(), handleGmbWebhook(), parseStarRating() (+7 more)
...
Cohesion: 0.12
Nodes (18): ACLRule, ACLRuleSchema, DeviceACL, DeviceACLSchema, DeviceTier, IDeviceACL, IRedemption, Redemption (+10 more)
...
Cohesion: 0.23
Nodes (4): chunk(), igPollMetricsInc(), InstagramPoller, registerAttentionCorrelationStart()
...
Cohesion: 0.14
Nodes (19): getCrossedMilestones(), buildGmbScreenPayload(), buildInstagramScreenPayload(), BuildScreenEnvelopeOpts, CelebrationState, CelebrationType, getInstagramMegaCrossedMilestones(), GmbReviewItem (+11 more)
...
Cohesion: 0.17
Nodes (17): WebhookConfig, DeviceGmbContext, createAccessTokenOAuthClient(), getGmbApiAuth(), GmbApiAuth, gmbApiErrorMeta(), locationCacheKeyFromResourceName(), pickAccessibleLocation() (+9 more)

### Community 36 - "Community 36"
Cohesion: 0.15
Nodes (13): FirmwareReleaseSchema, FirmwareReleaseStatus, FirmwareRolloutSchema, IFirmwareRollout, createOtaRoutes(), OciStorageError, checkOtaRateLimit(), getReleaseObjectKey() (+5 more)
...
Cohesion: 0.15
Nodes (6): shutdown(), ProvisioningConfig, ProvisioningService, ProvisioningTokenPayload, TokenValidationResult, getTokenStore()
...
Cohesion: 0.22
Nodes (7): metaValue(), OciFirmwareStorageService, isRetryableOciError(), mapOciError(), OciStorageErrorCode, statusFromMessage(), withOciRetry()
...
Cohesion: 0.13
Nodes (11): DeviceOtaState, DeviceSchema, DeviceStatus, FirmwareRolloutStrategy, OtaRoutesDeps, DeviceData, OtaEventHandler, compareVersions() (+3 more)
...
Cohesion: 0.18
Nodes (17): formatInstagramScreenMqttPayload(), ScreenDeliveryFetchShape, resolveCelebrationState(), buildStimIgPayload(), ensureStimIgLock(), releaseStimIgLock(), resolveLiveFollowersForStim(), runIgTick() (+9 more)
...
Cohesion: 0.21
Nodes (13): deprecatedWarned, envBool(), envInt(), envString(), resolveMqttClientId(), warnDeprecatedEnv(), loadConfig(), loadOciCredentialsFromEnv() (+5 more)
...
Cohesion: 0.21
Nodes (11): GmbReviewNotification, GmbReviewPayload, mapReviewPayloadToStorage(), ResolveGmbReviewPayloadOptions, GoogleBusinessReview, GoogleBusinessReviewSchema, IGoogleBusinessReview, GmbEnrichmentContext (+3 more)
...
Cohesion: 0.13
Nodes (20): computeAudience(), main(), loadWebhookConfig(), WebhookDeviceTarget, captureRawBody, createWebhookRoutes(), extractBearerToken(), gmbLimiter (+12 more)
...
Cohesion: 0.30
Nodes (11): clearAllPublishHashesForDevice(), clearPublishHash(), hashPayload(), publishForce(), publishHashRedisKey(), publishIfChanged(), stableJson(), createRedisService() (+3 more)
...
Cohesion: 0.13
Nodes (15): bun-types, eslint, devDependencies, bun-types, eslint, @types/node, @types/swagger-jsdoc, @types/swagger-ui-express (+7 more)
...
Cohesion: 0.17
Nodes (9): fetchInstagramProfileMetrics(), InstagramProfileFetchAudit, InstagramProfileFetchError, InstagramProfileFetchResult, InstagramProfileMetrics, sha256Hex(), fetchInstagramMetrics(), sleep() (+1 more)

### Community 76 - "Community 76"
Cohesion: 0.22
Nodes (10): createDashboardRoutes(), DashboardRoutesDeps, requireAuth(), sanitizeForDashboard(), verifyDeviceOwnership(), InfluxQueryRoutesDeps, IntegrationRoutesDeps, AuthService (+2 more)
...
Cohesion: 0.33
Nodes (8): ALLOWED_FLUX_FUNCTIONS, extractFunctionCalls(), KNOWN_MEASUREMENTS, sanitizeFluxQuery(), SanitizeResult, createInfluxQueryRoutes(), requireAdmin(), requireAuth()
...
Cohesion: 0.27
Nodes (7): IDevice, IUser, NOTE: This is a READ-ONLY model for mqtt-publisher-lite., User, UserSchema, DeviceVerificationResult, UserVerificationResult
...
Cohesion: 0.22
Nodes (4): createRecoverySessionService(), DeviceRecoveryJwtClaims, RecoverySessionError, RecoverySessionRedisState
...
Cohesion: 0.19
Nodes (18): startRolloutScheduler(), backfillFirmwareReleaseStageFields(), createOtaAdminRoutes(), requireAdminAuth(), AuditEntry, AuditEventType, AuditLogData, AuditServiceConfig (+10 more)
...
Cohesion: 0.09
Nodes (14): main(), mongodbSrvHostname(), sanitizeUri(), validateUriShape(), mongoDriverTimeouts(), createMongoService(), MongoConfig, MongoService (+6 more)
...
Cohesion: 0.50
Nodes (4): RFC-5280, ChainValidationResult, isChainValid(), validateCertificateChain()
...
Cohesion: 0.40
Nodes (3): createTransparencyLog(), TransparencyLogConfig, TransparencyProof
...
## Knowledge Gaps
- **779 isolated node(s):** `root`, `parser`, `@typescript-eslint`, `eslint:recommended`, `plugin:@typescript-eslint/recommended` (+774 more)
...
- **Why does `InfluxService` connect `Community 0` to `Community 3`, `Community 39`, `Community 12`, `Community 108`, `Community 112`, `Community 156`, `Community 16`, `husky.sh`, `post-applypatch`, `OtaTelemetryRepo`, `Community 92`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `logger` connect `Community 16` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `chainValidator.ts`, `Community 6`, `Community 8`, `Community 9`, `Community 12`, `Community 145`, `Community 19`, `Community 20`, `Community 21`, `Community 147`, `Community 31`, `Community 35`, `Community 36`, `Community 37`, `Community 39`, `Community 41`, `Community 43`, `Community 45`, `Community 47`, `Community 49`, `Community 50`, `Community 52`, `Community 56`, `Community 57`, `Community 58`, `Community 59`, `Community 62`, `Community 65`, `Community 67`, `Community 69`, `Community 73`, `Community 76`, `Community 87`, `Community 91`, `Community 99`, `Community 101`, `Community 112`, `Community 119`, `Community 125`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `StatsMqttLite` connect `Community 12` to `Community 0`, `Community 1`, `Community 2`, `Community 8`, `Community 10`, `Community 16`, `Community 17`, `Community 19`, `Community 20`, `Community 26`, `Community 37`, `Community 41`, `Community 43`, `Community 45`, `Community 50`, `Community 54`, `Community 58`, `Community 68`, `Community 76`, `Community 77`, `Community 78`, `Community 81`, `Community 83`, `Community 87`, `Community 98`, `Community 112`, `Community 116`, `Community 125`, `Community 127`?**
