# Graph Report - proofmqtt  (2026-09-05)

## Corpus Check
- 381 files · ~198,219 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2962 nodes · 5936 edges · 193 communities (153 shown, 40 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 8 edges (avg confidence: 0.76)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `14ac3441`
...
- [[_COMMUNITY_gmbSocial.ts|gmbSocial.ts]]
...
5. `OtaService` - 45 edges
6. `RedisService` - 41 edges
7. `getIgDeviceRuntimeCache()` - 38 edges
8. `LoyaltyService` - 37 edges
9. `getRedisService()` - 37 edges
10. `BootstrapHost` - 36 edges
...
Cohesion: 0.14
Nodes (12): checkSchedulerHeartbeat(), processRollouts(), FirmwareRelease, dashboardLink(), formatText(), sendOtaSlackAlert(), SlackOtaAlertKind, SlackOtaAlertPayload (+4 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (15): AuditService, ChainState, DeviceStateEvent, DeviceStateLogService, DeviceStateTransitionInput, mockGetInfluxService, getInfluxService(), OtaReleaseLog (+7 more)

### Community 2 - "Community 2"
Cohesion: 0.07
Nodes (31): baseConfig, atomicBackoffCheckAndRecordLua, atomicFetchBudgetTryLua, atomicPriorityReadAndPruneLua, AttentionE2eLatencySnapshot, buildLatencySnapshot(), correlationStartMs, counters (+23 more)

### Community 3 - "Community 3"
Cohesion: 0.10
Nodes (20): DeviceOtaStateSchema, DeviceOtaStatus, IDeviceOtaState, ObjectHeadResult, assertValidSha256Hex(), assertValidVersionFormat(), FinalizeValidationCode, FinalizeValidationError (+12 more)

### Community 4 - "Community 4"
Cohesion: 0.07
Nodes (13): DeviceOtaState, ActiveDevice, ActiveDeviceCache, DeviceData, DeviceService, normalizeActiveDevice(), baseDeviceData, mockDeviceFindOne (+5 more)
...
Cohesion: 0.13
Nodes (4): setMqttTlsClientPem(), areInstagramPollingScriptsLoaded(), MqttIngressHandlers, StatsMqttLite
...
Cohesion: 0.09
Nodes (22): dependencies, compression, cors, dotenv, express, express-rate-limit, google-auth-library, helmet (+14 more)

### Community 15 - "Community 15"
Cohesion: 0.06
Nodes (31): IDeviceCertificate, appClientDir, backupIfExists(), caConfig(), caStoragePath, cmdAppClient(), cmdInitCa(), cmdPrintAppEnv() (+23 more)
...
Cohesion: 0.10
Nodes (12): ProvisioningConfig, ProvisioningTokenPayload, mockTokenStore, TokenValidationResult, SessionData, nsToMs(), WebhookLatencyStages, WebhookLatencyTracker (+4 more)
...
Cohesion: 0.15
Nodes (10): DeviceStatus, DeviceCertificate, DeviceCertificateSchema, DeviceCertificateStatus, reissueLimiter, CAConfig, DeviceAlreadyHasCertificateError, RootCA (+2 more)

### Community 20 - "Community 20"
Cohesion: 0.10
Nodes (23): loadWebhookConfig(), validateWebhookConfig(), tryClaimWebhookDedupe(), buildWebhookApp(), mockAdvanceRollout, mockIngestRelease, buildApp(), mockAdvanceRollout (+15 more)
...
Cohesion: 0.22
Nodes (10): GmbFastScreenInput, GmbScreenAuditContext, GmbScreenPublishResult, publishGmbScreen(), resolveDevicesForUser(), sha256Payload(), shouldSkipForStimulate(), GmbEnrichmentContext (+2 more)

### Community 25 - "Community 25"
Cohesion: 0.17
Nodes (13): Business, BusinessSchema, IBusiness, ACLRule, ACLRuleSchema, DeviceACL, DeviceACLSchema, DeviceTier (+5 more)
...
Cohesion: 0.11
Nodes (19): LOYALTY_ACTIVE_SESSION_STATUSES, LoyaltySession, LoyaltySessionSchema, LoyaltySessionStatus, LOYALTY_IN_FLIGHT_SPIN_STATUSES, LoyaltySpin, LoyaltySpinResultSchema, LoyaltySpinSchema (+11 more)
...
Cohesion: 0.24
Nodes (14): buildTestOtaDownloadUrl(), deliverOtaOnRegistration(), executeOtaRegistrationDelivery(), fanOutTestOtaToActiveDevices(), publishTestOtaToDevice(), initializeOtaServices(), buildOtaProxyDownloadUrl(), resolveOtaDownloadMode() (+6 more)
...
Cohesion: 0.27
Nodes (9): extractMtlsIdentityFromNativeTls(), extractMtlsIdentityFromProxy(), firstHeader(), MtlsIdentity, normalizeForwardedPem(), parseCommonNameFromX509Subject(), deviceIdFromCertPem(), DeviceKeys (+1 more)
...
Cohesion: 0.16
Nodes (19): main(), MessageHandler, MqttConfig, MqttMessage, PendingAck, PublishMetadata, resolveMqttFullTopic(), applyMqttJsTlsOptions() (+11 more)
...
Cohesion: 0.16
Nodes (4): IFirmwareRelease, syncHashFieldsImmediate(), OtaService, isVersionGreater()

### Community 53 - "Community 53"
Cohesion: 0.08
Nodes (36): cache, cachedQuery(), CacheEntry, clearInfluxQueryCache(), influxQueryCacheSize(), getInstagramPollingMetricsSnapshot(), fetchInstagramProfileMetrics(), getIgFetchBodySizeSnapshot() (+28 more)

### Community 54 - "Community 54"
Cohesion: 0.21
Nodes (3): chunk(), InstagramDirectFetchInvoker, InstagramPoller
...
Cohesion: 0.12
Nodes (20): syncScreenFieldImmediate(), getRedisService(), REDIS_READ_COMMANDS, REDIS_WRITE_COMMANDS, RedisConfig, ActiveSetRedisClient, devicesNeedingHydration(), HydrateActiveDeviceFn (+12 more)
...
Cohesion: 0.11
Nodes (30): deprecatedWarned, envBool(), envInt(), envString(), warnDeprecatedEnv(), AppEnvConfig, AppFeaturesConfig, AuthConfig (+22 more)

### Community 62 - "Community 62"
Cohesion: 0.05
Nodes (62): formatInstagramScreenMqttPayload(), ScreenDeliveryFetchShape, getLocalStimLock(), buildGmbScreenPayload(), buildInstagramScreenPayload(), BuildScreenEnvelopeOpts, CelebrationState, CelebrationType (+54 more)

### Community 63 - "Community 63"
Cohesion: 0.19
Nodes (8): ILoyaltySpin, ILoyaltySpinResult, apiSpinStatus(), resultsEqual(), spinPublic(), toIso(), validateLoyaltyResult(), isDuplicateKeyError()

### Community 65 - "Community 65"
Cohesion: 0.18
Nodes (16): GoogleBusinessLocation, GoogleBusinessLocationSchema, IGoogleBusinessLocation, ISocial, Provider, Social, SocialSchema, DeviceGmbContext (+8 more)
...
Cohesion: 0.22
Nodes (7): buildPkiApp(), mockDeviceFindOne, createE2eApp(), sampleCertificateDoc(), createProvisioningRoutes(), buildProvisioningRoutesApp(), mockDeviceFindOne

### Community 68 - "Community 68"
Cohesion: 0.27
Nodes (10): BufferedMqttMessage, flushMessageBuffer(), handleCritical(), handleNonCritical(), isLifecycleTopic(), isMessageTooOld(), parseJsonPayload(), pushToBuffer() (+2 more)

### Community 69 - "Community 69"
Cohesion: 0.24
Nodes (7): LoyaltyConfig, createLoyaltyRoutes(), LoyaltyRoutesDeps, requireLoyaltySpinKey(), app(), loyalty, LoyaltyHttpError
...
Cohesion: 0.11
Nodes (19): devDependencies, bun-types, eslint, prettier, supertest, @types/compression, @types/cors, @types/express (+11 more)
...
Cohesion: 0.16
Nodes (12): abandonAttentionCorrelation(), applyInstagramServerlessDeviceOutcome(), getOutcomeCircuitGate(), igPollMetricsInc(), maybeApplyGlobalCircuit(), maybeOpenCircuitFromOutcome(), NormalizedDeviceFetchResult, publishInstagramScreenIfChanged() (+4 more)
...
Cohesion: 0.19
Nodes (16): GmbSocialContext, resolveGmbSocialContext(), WebhookProvider, getGmbAccountLookupValues(), GmbReviewNotification, buildGmbDedupeKey(), GmbReviewNotification, SUPPORTED_GMB_EVENT_TYPES (+8 more)
...
Cohesion: 0.21
Nodes (13): initializeHttpServer(), ConfigRoutesDeps, createConfigRoutes(), buildConfigRoutesApp(), createDashboardRoutes(), createInfluxQueryRoutes(), createIntegrationRoutes(), createOtaAdminRoutes() (+5 more)
...
Cohesion: 0.09
Nodes (5): Handler, ReuseHTTPServer, HttpServer, SessionService, SimpleHTTPRequestHandler
...
Cohesion: 0.13
Nodes (12): ILoyaltySession, ackLatency, clockDriftWarn, deviceAckSkew, failures, incLoyaltyClockDriftWarn(), incLoyaltySessionExpiry(), incLoyaltySpinFailure() (+4 more)
...
Cohesion: 0.12
Nodes (20): OtaConfig, OtaDownloadMode, FirmwareReleaseSchema, FirmwareReleaseStatus, FirmwareRolloutSchema, FirmwareRolloutStrategy, IFirmwareRollout, OtaAdminRoutesDeps (+12 more)
...
Cohesion: 0.12
Nodes (15): ALLOWED_FLUX_FUNCTIONS, extractFunctionCalls(), KNOWN_MEASUREMENTS, sanitizeFluxQuery(), SanitizeResult, InfluxQueryRoutesDeps, LEGACY_MEASUREMENTS, requireAdmin() (+7 more)

### Community 92 - "Community 92"
Cohesion: 0.17
Nodes (15): BootstrapHost, OtaRegistrationCoordinatorDeps, AppConfig, WebhookConfig, RolloutSchedulerHandle, ConnectRefreshCoordinator, ConnectRefreshCoordinatorDeps, FirmwareStorageService (+7 more)
...
Cohesion: 0.20
Nodes (10): createOtaReleaseLog(), getOtaReleaseLog(), OtaReleaseLogEntry, computeRootFromLeaves(), merkleHash(), mockGetAuditService, mockGetInfluxService, mockLogEvent (+2 more)
...
Cohesion: 0.26
Nodes (5): buildScreenEnvelope(), DeviceScreenState, SAMPLE_GMB_REVIEWS, StatsPublisher, TEST_GMB_V6_VARIANTS
...
Cohesion: 0.31
Nodes (5): RateEntry, isAllowedLoyaltyOrigin(), isDevLikeEnv(), isLoopbackHost(), isPrivateLanIPv4()

### Community 102 - "Community 102"
Cohesion: 0.29
Nodes (9): getLocalPublishHashCache(), ProvTokenEntry, clearAllPublishHashesForDevice(), clearPublishHash(), hashPayload(), publishForce(), publishHashRedisKey(), publishIfChanged() (+1 more)

### Community 103 - "Community 103"
Cohesion: 0.29
Nodes (4): DashboardRoutesDeps, readDashboardRange(), DASHBOARD_RANGES, parseDashboardRange()
...
Cohesion: 0.18
Nodes (19): cacheActiveDevice(), extractDeviceIdFromTopic(), handleDeviceLWT(), handleDeviceOtaTelemetry(), handleDeviceRegistration(), handleDeviceStatus(), sendRegistrationResponse(), getDeviceStateLogService() (+11 more)
...
Cohesion: 0.60
Nodes (3): GmbReviewPayload, mapReviewPayloadToStorage(), ResolveGmbReviewPayloadOptions

### Community 112 - "Community 112"
Cohesion: 0.29
Nodes (5): assertTestOtaAllowed(), isTestOtaEnabled(), checkOtaRateLimit(), LocalTestOtaFirmware, resolveLocalTestOtaFirmware()

### Community 113 - "Community 113"
Cohesion: 0.25
Nodes (7): businessId, deviceId, lastSeen, devices, 02332050A1CC, updatedAt, version
...
Cohesion: 0.25
Nodes (11): mongoDriverTimeouts(), colors, main(), sanitizeUri(), testMongoDB(), testRedis(), main(), main() (+3 more)

### Community 127 - "Community 127"
Cohesion: 0.18
Nodes (12): getSwaggerSpec(), resetSwaggerSpecCache(), resolveApiGlobs(), setupSwaggerUi(), swaggerDefinition, correlationIdMiddleware(), httpRequestDuration, httpRequestsTotal (+4 more)
...
Cohesion: 0.18
Nodes (10): WebhookDeviceTarget, Device, DeviceSchema, IDevice, ResolvedDeviceTarget, createRecoveryRoutes(), RecoveryRoutesDeps, buildRecoveryRoutesApp() (+2 more)
...
Cohesion: 0.06
Nodes (32): OtaOciConfig, mockAppendFileSync, mockFsModule(), mockInfluxDbClientModule(), mockLoggerModule(), mockMkdirSync, mockOciCreatePAR, mockOciGetObject (+24 more)
...
Cohesion: 0.17
Nodes (10): invokeMtls(), mockFindOne, requireMtlsDeviceCert(), createMockRes(), mockFindOne, runMiddleware(), createLifecycleRoutes(), LifecycleDeps (+2 more)
...
Cohesion: 0.40
Nodes (4): fetchInstagramMetrics(), sleep(), httpGet(), HttpProbeResult
...
Cohesion: 0.13
Nodes (20): REDIS_KEYS, check(), main(), Result, results, smokeLocalCaches(), smokeProvAndSync(), DeviceRuntimeState (+12 more)

## Knowledge Gaps
- **1021 isolated node(s):** `railway`, `root`, `parser`, `plugins`, `extends` (+1016 more)
...
- **Why does `logger` connect `Community 17` to `Community 0`, `Community 1`, `Community 130`, `Community 2`, `Community 4`, `Community 3`, `Community 10`, `Community 142`, `Community 15`, `Community 19`, `Community 20`, `Community 23`, `Community 24`, `Community 29`, `Community 32`, `Community 33`, `Community 34`, `Community 37`, `Community 38`, `Community 46`, `Community 51`, `Community 53`, `Community 56`, `Community 57`, `Community 59`, `Community 61`, `Community 62`, `transparencyLog.ts`, `Community 65`, `Community 68`, `Community 69`, `Community 74`, `Community 78`, `Community 79`, `Community 80`, `Community 81`, `Community 83`, `Community 88`, `Community 91`, `Community 92`, `Community 94`, `Community 95`, `Community 96`, `Community 101`, `Community 105`, `Community 112`, `Community 127`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `InfluxService` connect `Community 5` to `husky.sh`, `Community 33`, `Community 66`, `Community 161`, `Community 100`, `Community 10`, `Community 12`, `pre-push`, `pre-push`, `pre-rebase`, `prepare-commit-msg`, `swagger-jsdoc`, `Community 79`, `Community 78`, `Community 117`, `Community 118`, `post-checkout`, `Community 92`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `StatsMqttLite` connect `Community 12` to `Community 1`, `Community 4`, `Community 5`, `Community 142`, `Community 15`, `Community 27`, `Community 39`, `Community 47`, `Community 52`, `Community 53`, `Community 54`, `Community 57`, `Community 61`, `transparencyLog.ts`, `Community 64`, `Community 75`, `Community 81`, `Community 82`, `Community 85`, `Community 91`, `Community 92`, `Community 96`?**
