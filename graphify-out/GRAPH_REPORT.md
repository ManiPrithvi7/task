...
## Corpus Check
- 290 files · ~159,334 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2506 nodes · 4789 edges · 173 communities (136 shown, 37 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7a6dea9e`
...
6. `OtaService` - 41 edges
7. `OtaRedisState` - 34 edges
8. `CAService` - 31 edges
9. `getActiveDeviceCache()` - 29 edges
10. `getInfluxService()` - 24 edges
...
## Communities (173 total, 37 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.09
Nodes (41): getClaimBaseUrl(), Campaign, CampaignSchema, CampaignStatus, DiscountType, ICampaign, ScheduleType, TargetType (+33 more)

### Community 2 - "Community 2"
Cohesion: 0.07
Nodes (15): ALLOWED_FLUX_FUNCTIONS, extractFunctionCalls(), KNOWN_MEASUREMENTS, sanitizeFluxQuery(), SanitizeResult, createInfluxQueryRoutes(), InfluxQueryRoutesDeps, requireAdmin() (+7 more)

### Community 3 - "Community 3"
Cohesion: 0.06
Nodes (33): DeviceMetaReadMode, areInstagramPollingScriptsLoaded(), atomicBackoffCheckAndRecordLua, atomicFetchBudgetTryLua, atomicPriorityReadAndPruneLua, AttentionE2eLatencySnapshot, buildLatencySnapshot(), correlationStartMs (+25 more)
...
Cohesion: 0.10
Nodes (3): OtaRedisState, isValidRolloutStep(), mapPool()
...
Cohesion: 0.11
Nodes (26): tryClaimWebhookDedupe(), GmbFastScreenInput, GmbScreenAuditContext, GmbScreenPublishResult, resolveGmbSocialContext(), resolveDevicesForUser(), getGmbAccountLookupValues(), GmbReviewNotification (+18 more)

### Community 9 - "Community 9"
Cohesion: 0.08
Nodes (28): rejectRateLimited(), DeviceOtaState, AuditEntry, AuditEventType, AuditLogData, AuditServiceConfig, getAuditService(), ObjectHeadResult (+20 more)

### Community 10 - "Community 10"
Cohesion: 0.12
Nodes (26): createGoogleBusinessOAuth2Client(), getValidOAuth2Client(), isInvalidGrant(), refreshAccessTokenIfNeeded(), GoogleBusinessLocation, GoogleBusinessLocationSchema, GoogleBusinessProfile, GoogleBusinessProfileSchema (+18 more)
...
Cohesion: 0.05
Nodes (30): backfillFirmwareReleaseStageFields(), createOtaAdminRoutes(), createAuditService(), createInfluxService(), BufferedMqttMessage, flushMessageBuffer(), handleCritical(), handleNonCritical() (+22 more)
...
Cohesion: 0.08
Nodes (19): checkLocalShortCircuit(), csrRateLimiter(), DEFAULT_CONFIG, incrementLocalCounter(), localCounters, RateLimitConfig, resetCsrLocalCounters(), mockGetRedis (+11 more)

### Community 18 - "Community 18"
Cohesion: 0.12
Nodes (26): REDIS_KEYS, DeviceRuntimeState, getIgDeviceRuntimeCache(), hydrateGmbReviewCountFromRedis(), markDeviceHashInactive(), parseMetaFromHash(), readFollowerCountForRepublish(), ResolvedDeviceMeta (+18 more)

### Community 19 - "Community 19"
Cohesion: 0.15
Nodes (19): publishGmbScreen(), ConnectRefreshCoordinator, ConnectRefreshCoordinatorDeps, getActiveDeviceCache(), GmbConnectPull, ActiveSetRedisClient, devicesNeedingHydration(), HydrateActiveDeviceFn (+11 more)

### Community 20 - "Community 20"
Cohesion: 0.12
Nodes (28): AppEnvConfig, AppFeaturesConfig, AuthConfig, decodeBase64ToUtf8(), DEFAULT_PROVISIONING_CA_STORAGE_PATH, describePrivateKeyPemKind(), firstPemEnv(), getProvisioningRootCaCertFromEnv() (+20 more)
...
Cohesion: 0.12
Nodes (13): DeviceOtaEventInput, InstagramAuditRepo, OtaTelemetryInput, InstagramCircuitEventInfluxInput, InstagramFetchAuditInfluxInput, InstagramMilestoneCrossedInfluxInput, InstagramMqttDeliveryInfluxInput, MilestoneCrossedInfluxInput (+5 more)
...
Cohesion: 0.11
Nodes (19): checkSchedulerHeartbeat(), processRollouts(), RolloutSchedulerHandle, startRolloutScheduler(), FirmwareRelease, FirmwareReleaseSchema, FirmwareReleaseStatus, FirmwareRolloutSchema (+11 more)
...
Cohesion: 0.17
Nodes (8): InfluxDBConfig, BaseInfluxRepo, BucketTarget, OtaReleaseEntryInput, TransparencyEntryInput, OtaTelemetryRepo, PkiAuditInput, PkiAuditRepo
...
Cohesion: 0.16
Nodes (14): OtaConfig, OtaAdminRoutesDeps, IFirmwareStorage, isOtaSigningConfirmed(), OtaCommandPublisher, setOtaSigningConfirmed(), getReleaseObjectKey(), buildOtaDownloadUrl() (+6 more)
...
Cohesion: 0.13
Nodes (14): requireMtlsDeviceCert(), DeviceCertificate, DeviceCertificateSchema, DeviceCertificateStatus, createLifecycleRoutes(), LifecycleDeps, reissueLimiter, buildLifecycleRoutesApp() (+6 more)
...
Cohesion: 0.18
Nodes (4): chunk(), igPollMetricsInc(), InstagramDirectFetchInvoker, InstagramPoller

### Community 40 - "Community 40"
Cohesion: 0.11
Nodes (16): WebhookConfig, WebhookDeviceTarget, DeviceStatus, ResolvedDeviceTarget, captureRawBody, gmbLimiter, otaReleaseLimiter, OtaReleaseWebhookDeps (+8 more)

### Community 41 - "Community 41"
Cohesion: 0.17
Nodes (8): FirmwareStorageService, OciFirmwareStorageService, isRetryableOciError(), mapOciError(), OciStorageError, OciStorageErrorCode, statusFromMessage(), withOciRetry()
...
Cohesion: 0.19
Nodes (17): Ad, AdSchema, AdStatus, AdType, IAd, buildBrandCanvasPayload(), CachedBrandCanvasDto, canvasActiveKey() (+9 more)

### Community 45 - "Community 45"
Cohesion: 0.27
Nodes (13): setMqttTlsClientPem(), main(), applyMqttJsTlsOptions(), buildMqttTlsPrecheckOptions(), buildNodeTlsConnectOptions(), netIsIp(), normalizeTlsPem(), readMqttTlsVersionOptions() (+5 more)
...
Cohesion: 0.16
Nodes (9): BudgetTracker, consumeFetchBudget(), DeviceBackoff, FairOffset, FetchDedupe, LocalBudgetTracker, LocalDeviceBackoff, LocalFairOffset (+1 more)
...
Cohesion: 0.13
Nodes (9): createOtaRoutes(), OtaRoutesDeps, buildApp(), mockHandle, checkOtaRateLimit(), eventKey(), OtaEventHandler, LocalTestOtaFirmware (+1 more)
...
Cohesion: 0.16
Nodes (16): loadWebhookConfig(), buildApp(), mockAdvanceRollout, mockIngestRelease, mockMqttClient, createWebhookRoutes(), buildApp(), mockMqttClient (+8 more)
...
Cohesion: 0.15
Nodes (3): DeviceService, isTransientMongoError(), withMongoRetry()
...
Cohesion: 0.16
Nodes (7): WebhookAuditRepo, GmbReviewSnapshotInfluxInput, GmbVelocityWeeklyInfluxInput, GmbWebhookAuditInfluxInput, WebhookDeviceResolutionInfluxInput, WebhookMqttDeliveryInfluxInput, WebhookReceivedInfluxInput
...
Cohesion: 0.16
Nodes (13): abandonAttentionCorrelation(), applyInstagramServerlessDeviceOutcome(), getCircuitBreaker, getCrossedMilestones(), getOutcomeCircuitGate(), maybeApplyGlobalCircuit(), maybeOpenCircuitFromOutcome(), normalizeResponseBody() (+5 more)
...
Cohesion: 0.27
Nodes (10): deprecatedWarned, envBool(), envInt(), envString(), resolveMqttClientId(), warnDeprecatedEnv(), loadConfig(), normalizeInfluxDbUrl() (+2 more)

### Community 85 - "Community 85"
Cohesion: 0.08
Nodes (14): mongoDriverTimeouts(), colors, main(), sanitizeUri(), testMongoDB(), testRedis(), main(), mongodbSrvHostname() (+6 more)
...
Cohesion: 0.27
Nodes (9): OtaOciConfig, main(), parseArgs(), sha256Hex(), createFirmwareStorageService(), createOciAuthProvider(), hasOciEnvCredentials(), normalizePemFromEnv() (+1 more)
...
Cohesion: 0.42
Nodes (6): DeviceOtaEventsRepo, influxNsFromDate(), isValidInfluxNs(), normalizeInfluxTimestamp(), parseLineProtocolTimestampNs(), sanitizeInfluxLineProtocol()
...
Cohesion: 0.07
Nodes (36): Device, DeviceSchema, IDevice, IUser, User, UserSchema, createDashboardRoutes(), DashboardRoutesDeps (+28 more)
...
Cohesion: 0.40
Nodes (3): InstagramServerlessConfig, InstagramFetchInvoker, InstagramServerlessBridge
...
## Knowledge Gaps
- **907 isolated node(s):** `root`, `parser`, `plugins`, `extends`, `project` (+902 more)
...
- **Why does `InfluxService` connect `Community 1` to `Community 8`, `Community 106`, `Community 43`, `Community 12`, `Community 78`, `Community 112`, `Community 24`, `Community 122`, `Community 156`, `influxConfig.test.ts`, `Community 31`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **Why does `logger` connect `Community 112` to `Community 0`, `Community 2`, `Community 3`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 24`, `Community 26`, `Community 31`, `Community 35`, `Community 37`, `Community 40`, `Community 41`, `Community 43`, `Community 44`, `Community 52`, `Community 54`, `Community 55`, `Community 56`, `Community 73`, `Community 77`, `Community 84`, `Community 85`, `Community 87`, `Community 91`, `Community 99`, `Community 101`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `StatsMqttLite` connect `Community 12` to `Community 1`, `Community 2`, `chainValidator.ts`, `Community 6`, `Community 17`, `Community 146`, `Community 19`, `Community 26`, `Community 35`, `Community 39`, `Community 47`, `Community 49`, `Community 56`, `Community 57`, `Community 58`, `Community 69`, `Community 76`, `Community 83`, `Community 85`, `Community 87`, `Community 90`, `Community 98`, `Community 108`, `Community 112`, `Community 116`, `Community 124`?**
