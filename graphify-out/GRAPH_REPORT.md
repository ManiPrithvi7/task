# Graph Report - proofmqtt  (2026-06-23)

## Corpus Check
- 201 files · ~110,886 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1780 nodes · 3566 edges · 123 communities (97 shown, 26 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3c25616a`
...
2. `logger` - 67 edges
3. `getRedisService()` - 50 edges
4. `MqttClientManager` - 48 edges
5. `InfluxService` - 36 edges
6. `CAService` - 31 edges
7. `MqttMessageViewer` - 26 edges
8. `OtaService` - 26 edges
9. `StatsPublisher` - 23 edges
10. `getActiveDeviceCache()` - 22 edges
...
- `buildApp()` --calls--> `createOtaRoutes()`  [EXTRACTED]
  tests/unit/routes/otaRoutes.test.ts → src/routes/otaRoutes.ts
...
Cohesion: 0.06
Nodes (53): deprecatedWarned, envBool(), envInt(), envString(), resolveMqttClientId(), warnDeprecatedEnv(), AppEnvConfig, AppFeaturesConfig (+45 more)
...
Cohesion: 0.07
Nodes (32): GmbFastScreenInput, GmbScreenAuditContext, GmbScreenPublishResult, publishGmbScreen(), PosScreenAuditContext, PosScreenInput, PosScreenPublishResult, HttpConfig (+24 more)

### Community 3 - "Community 3"
Cohesion: 0.08
Nodes (35): getClaimBaseUrl(), resolveConnectionsValidateApiKey(), ConnectionsRoutesDeps, createConnectionsRoutes(), PROVIDER_MAP, app(), mockHandler, VALID_EVENTS (+27 more)

### Community 4 - "Community 4"
Cohesion: 0.06
Nodes (30): areInstagramPollingScriptsLoaded(), atomicBackoffCheckAndRecordLua, atomicFetchBudgetTryLua, atomicPriorityReadAndPruneLua, AttentionE2eLatencySnapshot, buildLatencySnapshot(), correlationStartMs, counters (+22 more)
...
Cohesion: 0.12
Nodes (27): DailyMetricsRedisKeys, DateBucketResult, getDailyMetricsKeys(), getDateBucket(), getDateKeyForInstant(), getPosDailyCacheKeys(), getPosDailyCacheTtlSec(), getStartOfDayInTimezone() (+19 more)
...
Cohesion: 0.10
Nodes (6): ProvisioningConfig, ProvisioningService, ProvisioningTokenPayload, TokenValidationResult, getTokenStore(), TokenStore

### Community 9 - "Community 9"
Cohesion: 0.12
Nodes (14): ConnectRefreshCoordinator, clearAllPublishHashesForDevice(), clearPublishHash(), hashPayload(), publishForce(), publishHashRedisKey(), publishIfChanged(), stableJson() (+6 more)

### Community 10 - "Community 10"
Cohesion: 0.13
Nodes (25): WebhookConfig, WebhookDeviceTarget, tryClaimWebhookDedupe(), createGoogleBusinessOAuth2Client(), getValidOAuth2Client(), isInvalidGrant(), refreshAccessTokenIfNeeded(), DeviceTransactionLog (+17 more)

### Community 11 - "Community 11"
Cohesion: 0.15
Nodes (23): getSquareWebhookUrl(), buildShopifyDedupeKey(), buildSquareDedupeKey(), publishPosScreen(), resolveShopifyUserId(), resolveSquareUserId(), webhookInfluxBatch(), getOrderId() (+15 more)

### Community 12 - "Community 12"
Cohesion: 0.12
Nodes (4): setMqttTlsClientPem(), createMongoService(), createRedisService(), StatsMqttLite
...
Cohesion: 0.06
Nodes (31): dependencies, better-sqlite3, compression, cors, dotenv, express, express-rate-limit, google-auth-library (+23 more)
...
Cohesion: 0.11
Nodes (22): Ad, AdSchema, AdStatus, AdType, IAd, ACLRule, ACLRuleSchema, DeviceACL (+14 more)
...
Cohesion: 0.12
Nodes (11): mongoDriverTimeouts(), colors, main(), sanitizeUri(), testMongoDB(), testRedis(), main(), mongodbSrvHostname() (+3 more)

### Community 19 - "Community 19"
Cohesion: 0.13
Nodes (14): csrRateLimiter(), requireMtlsDeviceCert(), DeviceCertificate, DeviceCertificateSchema, DeviceCertificateStatus, createLifecycleRoutes(), LifecycleDeps, reissueLimiter (+6 more)

### Community 20 - "Community 20"
Cohesion: 0.20
Nodes (6): chunk(), evalAtomicBackoffCheckAndRecordEvalSha(), igPollMetricsInc(), InstagramDirectFetchInvoker, InstagramPoller, registerAttentionCorrelationStart()

### Community 21 - "Community 21"
Cohesion: 0.11
Nodes (18): ObjectHeadResult, assertValidSha256Hex(), assertValidVersionFormat(), checkOtaRateLimit(), FinalizeValidationCode, FinalizeValidationError, FinalizeValidationInput, isOtaSigningConfirmed() (+10 more)
...
Cohesion: 0.17
Nodes (15): loadWebhookConfig(), buildApp(), mockIngestRelease, mockMqttClient, createWebhookRoutes(), buildApp(), mockMqttClient, mockPublish (+7 more)
...
Cohesion: 0.20
Nodes (12): Campaign, CampaignSchema, CampaignStatus, DiscountType, ICampaign, ScheduleType, TargetType, IRedemption (+4 more)
...
Cohesion: 0.11
Nodes (17): 1. Check Health, 2. Publish MQTT Message, ⚡ 30-Second Setup, 3. Subscribe with Mosquitto, 4. Register a Device, 5. Get All Devices, Can't connect to MQTT broker?, 📂 Check Your Data (+9 more)

### Community 34 - "Community 34"
Cohesion: 0.11
Nodes (17): Attack surface (production), Change log, Controls verified (positive), Executive summary, Findings, H-1: mTLS identity from proxy header without fingerprint binding, H-2: OTA admin — any valid user JWT, H-3: Unauthenticated dev OTA download proxy (+9 more)

### Community 35 - "Community 35"
Cohesion: 0.22
Nodes (4): IDevice, IFirmwareRelease, OtaService, DeviceVerificationResult

### Community 36 - "Community 36"
Cohesion: 0.17
Nodes (13): GoogleBusinessLocation, GoogleBusinessLocationSchema, IGoogleBusinessLocation, GoogleBusinessProfile, GoogleBusinessProfileSchema, IGoogleBusinessProfile, ISocial, Social (+5 more)
...
Cohesion: 0.14
Nodes (11): createOtaAdminRoutes(), createRecoveryRoutes(), OtaReleaseWebhookDeps, createAuditService(), ChainValidationResult, isChainValid(), validateCertificateChain(), initOtaSigningState() (+3 more)

### Community 39 - "Community 39"
Cohesion: 0.23
Nodes (13): main(), applyMqttJsTlsOptions(), buildMqttTlsPrecheckOptions(), buildNodeTlsConnectOptions(), netIsIp(), normalizeTlsPem(), readMqttTlsVersionOptions(), readTlsVersion() (+5 more)
...
Cohesion: 0.23
Nodes (10): FirmwareRelease, FirmwareReleaseSchema, FirmwareReleaseStatus, FirmwareRolloutSchema, FirmwareRolloutStrategy, IFirmwareRollout, createOtaRoutes(), buildApp() (+2 more)

### Community 44 - "Community 44"
Cohesion: 0.23
Nodes (13): IShopifyProfile, ShopifyProfile, ShopifyProfileSchema, applySocialDisconnected(), cacheKey(), cacheUserIntegrations(), getUserIntegrations(), getUserIntegrationsCacheTtlSec() (+5 more)
...
Cohesion: 0.14
Nodes (8): rejectRateLimited(), DeviceOtaState, AuditEntry, AuditEventType, AuditLogData, AuditServiceConfig, getAuditService(), eventKey()
...
Cohesion: 0.18
Nodes (3): TransparencyLog, TransparencyLogConfig, TransparencyProof
...
Cohesion: 0.28
Nodes (8): GmbReviewPayload, mapReviewPayloadToStorage(), ResolveGmbReviewPayloadOptions, getShopifyWebhookSecret(), getSquareWebhookSignatureKey(), verifyShopifyIngress(), verifySquareIngress(), WebhookVerificationResult
...
Cohesion: 0.23
Nodes (8): Device, DeviceSchema, DeviceStatus, mockStorage, otaConfig, DevicePosContext, compareVersions(), isVersionGreater()

### Community 55 - "Community 55"
Cohesion: 0.27
Nodes (8): OtaCommandPublisher, buildOtaDownloadUrl(), buildOtaMqttDownloadUrl(), isLocalLanDownloadUrl(), isOciFirmwareDownloadUrl(), otaConfig, proxyOtaConfig, release
...
Cohesion: 0.35
Nodes (8): incrementCampaignUsage(), toCents(), getIdString(), runShopifyAsyncMetrics(), runSquareAsyncMetrics(), codeFromDiscount(), extractSquareDiscountCodes(), squareDiscountAmountCents()
...
Cohesion: 0.24
Nodes (5): ProvisioningDependencies, RecoveryRoutesDeps, AuthService, AuthTokenPayload, AuthTokenVerificationResult
...
Cohesion: 0.25
Nodes (4): nsToMs(), WebhookLatencyStages, WebhookLatencyTracker, WebhookProvider
...
Cohesion: 0.25
Nodes (8): devDependencies, jest, supertest, ts-jest, ts-node, ts-node-dev, @types/jest, @types/supertest
...
Cohesion: 0.25
Nodes (6): captureRawBody, gmbLimiter, otaReleaseLimiter, shopifyLimiter, squareLimiter, WebhookRoutesDeps
...
Cohesion: 0.33
Nodes (5): Env reference, Implemented (dev complete), Production cutover (statsmqtt only), Shadow mode, Webhook → MQTT migration (ops)
...
Cohesion: 0.33
Nodes (5): evalAtomicFetchBudgetTryEvalSha(), evalAtomicPriorityReadAndPruneEvalSha(), evalShaWithFallback(), isNoScript(), loadInstagramPollingScripts()
...
Cohesion: 0.67
Nodes (3): AppConfig, ConfigRoutesDeps, createConfigRoutes()
...
## Knowledge Gaps
- **578 isolated node(s):** `_postman_id`, `name`, `description`, `schema`, `item` (+573 more)
...
- **Why does `logger` connect `Community 2` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 6`, `Community 8`, `Community 10`, `Community 11`, `Community 16`, `Community 19`, `Community 21`, `Community 28`, `Community 30`, `Community 31`, `Community 36`, `Community 38`, `Community 43`, `Community 44`, `Community 47`, `Community 49`, `Community 54`, `Community 59`, `Community 65`, `Community 68`, `Community 73`, `Community 98`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `StatsMqttLite` connect `Community 12` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 8`, `Community 9`, `Community 18`, `Community 20`, `Community 26`, `Community 29`, `Community 30`, `Community 35`, `Community 38`, `Community 39`, `Community 40`, `Community 45`, `Community 49`, `Community 50`, `Community 55`, `Community 58`, `Community 62`, `Community 63`, `Community 65`, `Community 67`, `Community 74`, `Community 75`, `Community 82`, `Community 90`, `Community 99`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `InfluxService` connect `Community 1` to `Community 11`, `Community 12`, `Community 77`, `Community 38`?**
